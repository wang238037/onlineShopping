    ...
    <div class="order-right">
        <div class="order-content">
                    ...
                    <tbody>
                        <tr v-for="(orderDetail, index) in  record.orderDetailList " :key="orderDetail.id">
                            ...
                            <template v-if="index == 0">
                                <td :rowspan="record.orderDetailList.length" width="8%" class="center">{{ record.consignee
                                }}
                                </td>
            ...
            <div class="choose-order">
                ...
                <el-pagination background @current-change="handleCurrentChange" :current-page.sync="page" :page-size="limit"
                    layout="total, prev, pager, next" :total="myorder.total">
                </el-pagination>
            </div>
        </div>
        <!--猜你喜欢-->
...
export default {
    ...
    methods: {
        async getData() {
            let result = await reqOrderList(this.page, this.limit)
            if (result.code == 200) {
