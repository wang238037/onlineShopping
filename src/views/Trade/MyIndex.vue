    ...
    <div class="content">
      ...
      <div class="detail">
        ...
        <ul class="list clearFix" v-for="(order) in orderInfo.detailArrayList" :key="order.skuId">
          ...
          <li>
            <p style="width: 450px;white-space: nowrap;overflow: hidden;text-overflow: ellipsis;">{{ order.skuName }}</p>
            <h4>7天无理由退货</h4>
          </li>
          <li>
...
export default {
  ...
  methods: {
    ...
    async submitOrder() {
      ...
      let result = await reqSubmitOrder(this.orderInfo.tradeNo,data)
      if(result.code==200){
