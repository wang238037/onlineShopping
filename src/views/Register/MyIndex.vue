<template>
  <div class="register-container">
    ...
    <div class="register">
      ...
      <div class="controls">
        <input type="checkbox" v-model="agree" name="agree" v-validate="{ required: true, 'myagree': true }"
...
export default {
  ...
  methods: {
    ...
    async userRegister() {
      ...
      if (success) {
        try {
          await this.$store.dispatch('reqUserRegister', { phone: this.phone, password: this.password, code: this.code })
